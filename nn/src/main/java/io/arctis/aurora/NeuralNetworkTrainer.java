...
import io.arctis.aurora.loss.LossFunction;
import io.arctis.aurora.loss.MSE;
import io.arctis.aurora.model.EpochAction;
import io.arctis.aurora.noise.Noise;
import io.arctis.aurora.policy.DecayPolicy;
import io.arctis.aurora.publics.io.ComplexProgressTicker;
import io.arctis.aurora.model.Evaluation;
import io.arctis.aurora.model.ModelMetrics;
import io.arctis.aurora.model.IterableTimeEstimator;
...
import io.arctis.aurora.publics.Ticker;
...
public class NeuralNetworkTrainer extends AbstractNeuralNetwork implements NeuralNetwork {
  ...
  protected final LossFunction lossFunction = new MSE();
  protected Consumer<NeuralNetwork> completion;
  protected double learningRateDecayRate;
  ...
  public NeuralNetworkTrainer(@Nonnull NeuralNetworkBuilder builder) {
    ...
    this.learningRateDecayRate = builder.learningRateDecayRate;
